...
oyCrosswordMenu.prototype.checkAll = function(){
	...
	if  (checked == 0){
		this.footer.stateError("Please write all the words to rate");
	} else {
        ...
        this.footer.stateOk(this.obtenerRetroalimentacion() + "So far you have found "+this.matches+" the "+this.clues.length+" words in the crossword puzzle.");
	}
	function showError() {
		var errorDiv = document.getElementById("oygState");
		errorDiv.classList.add("show");
	
		// Opcional: Remover el mensaje después de un tiempo
		setTimeout(function() {
			errorDiv.classList.remove("show");
		}, 3000); // El tiempo en milisegundos que el mensaje estará visible
	}
