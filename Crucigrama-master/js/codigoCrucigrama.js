var oygCrosswordPuzzle = new oyCrosswordPuzzle(
    ...
    [
        ...
        */
        ...
        new oyCrosswordClue(6, "a small, electronic device that is often new and unconventional", "Gatget", "", 0, 8, 3),
        ...
        new oyCrosswordClue(3, "A system for programmers to manage code content and other versions.", "Git", "", 1, 14, 7)
    ],
